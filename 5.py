...
def investir_em_bitcoin(valor_mensal, saldo_bitcoin=0, meses=0, investido=0, bateu_100k=False, marco_1bitcoin=False):
    ...
    if not bateu_100k and saldo_reais >= 100000:
        bateu_100k = True
    ...
    return investir_em_bitcoin(valor_mensal, saldo_bitcoin, meses + 1, investido, bateu_100k, marco_1bitcoin)
